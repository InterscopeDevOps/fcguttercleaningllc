...
const ServicesHome2: React.FC<ServicesHomeProps> = ({ dataGlobal, homeSection, landingServices, dbServices, slidesPerView = 3, onePage }) => {
    return (
            ...
            <div className="flex justify-center items-center">
                ...
                >
                    {dbServices.map((service, index) => (
                        <SwiperSlide key={index} className="flex flex-col justify-center items-center py-5 w-full">
                            <div
                                className="relative overflow-hidden md:w-full w-full h-80 rounded-3xl cursor-pointer text-2xl font-bold group">
                                <picture>
                                    <img
